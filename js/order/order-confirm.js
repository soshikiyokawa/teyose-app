...
function openOrderPreview(){
  ...
  currentOrder={no,project,date,dueDate,dueAsap:!receipt&&orderDueAsap,costType,paymentMethod:payment,suppliers:sup.name,supplierObj:sup,items:orderItems,subtotal,tax,total:subtotal+tax};
